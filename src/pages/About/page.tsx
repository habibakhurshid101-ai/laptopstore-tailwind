          ...
          {[
            ...
            <div key={i} className="w-[220px] p-8 bg-bg-card border border-border-primary rounded-md text-center space-y-4 hover:border-brand-primary transition-all duration-300 group">
              <div className={`w-20 h-20 mx-auto flex items-center justify-center rounded-full text-4xl border-2 transition-all duration-500
                ${member.color === 'blue' ? 'bg-[radial-gradient(circle,rgba(26,86,219,0.2),var(--color-bg-card))] border-brand-primary' : ''}
                ${member.color === 'purple' ? 'bg-[radial-gradient(circle,rgba(124,58,237,0.2),var(--color-bg-card))] border-brand-secondary' : ''}
                ${member.color === 'sky' ? 'bg-[radial-gradient(circle,rgba(14,165,233,0.2),var(--color-bg-card))] border-brand-third' : ''}
                ${member.color === 'green' ? 'bg-[radial-gradient(circle,rgba(6,214,160,0.2),var(--color-bg-card))] border-brand-accent' : ''}
              `}>
                {member.icon}
              </div>
